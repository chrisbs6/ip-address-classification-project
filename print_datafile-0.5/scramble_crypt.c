 ...
 * $Id: scramble_crypt.c 17581 2013-07-11 02:06:52Z liangzhu $
 *
...
#ifdef HAVE_AES
		case SCRAMBLE_AES:
			AES_ecb_encrypt((u_char*)&b4_in, (u_char*)&b4_out, &aes_key, AES_ENCRYPT);
			break;
#endif
		case SCRAMBLE_SHA1:
		...
		for (i = 31; i > pbits - 1; --i) {
			...
			case SCRAMBLE_AES:
				AES_ecb_encrypt((u_char*)&b6_in, (u_char*)&b6_out, 
						&scramble_key.aes_key, AES_ENCRYPT);
				break;
#endif
			case SCRAMBLE_SHA1:
